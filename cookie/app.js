// gsap.to('.text', {y: 50, duration: 1, opacity: 0})
// gsap.fromTo('.text', { opacity: 0, y: 20}, {opacity: 1, duration: 1, y: 0})
...
tl.fromTo('.cookie', {y:0, rotation: '0deg'}, {y: 0, yoyo: true, rotation: '-20deg', repeat: -1})
